function [eps,ome,pstrains,rotc,rot] = InfStrainModif(e)
...
pstrains(1,1) = D(3,3);
[pstrains(1,2),pstrains(1,3)] = CartToSph(V(2,3),V(1,3),V(3,3));
%Intermediate principal strain
pstrains(2,1) = D(2,2); 
[pstrains(2,2),pstrains(2,3)] = CartToSph(V(2,2),V(1,2),V(3,2));
%Minimum principal strain
pstrains(3,1) = D(1,1); 
[pstrains(3,2),pstrains(3,3)] = CartToSph(V(2,1),V(1,1),V(3,1));
