function []=mohrs2Modif(StrainState, option, poissons, angle)
...
% *** This script is modified by Chris Kim (January, 2017.)

StrainState=StrainState*1e8;
ex=StrainState(1);
ey=StrainState(2);
gxy=StrainState(3);
center=mean([ex,ey]);
...
if nargin==4
  AngleToHorPlane=atan2(gxy,(ey-center));
